...
import { agentProgressSchema, agentResponseSchema, } from "../../modules/chats/chats.schema";
...
chatRoutes.post("/agent-progress", validate(agentProgressSchema), chatToolController.agentProgress);
export { chatRoutes };
