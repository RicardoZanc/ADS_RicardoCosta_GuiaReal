...
export async function seedTechnicalFacts({ nodes, community, }) {
    const [floydVerified, ipsHypothesis, humbuckerDisputed] = await Promise.all([
        prisma.technical_facts.create({
            data: {
                ...
                fact_description: "A ponte de microafinação Floyd Rose oferece estabilidade extrema com contrapressão calibrada, mas demanda lubrificação e ajuste periódico dos carrinhos.",
        ...
        prisma.technical_facts.create({
            data: {
                ...
                fact_description: "Monitores com painel IPS mantêm fidelidade de cor em ângulos amplos, favorecendo trabalho criativo e revisão de imagem.",
                consensus_score: 0.4,
                status: "HYPOTHESIS",
            },
        }),
        prisma.technical_facts.create({
            data: {
                ...
                fact_description: "Captadores humbucker cancelam ruído eletromagnético por construção de bobinas em série, mas podem soar menos brilhantes que single-coils.",
