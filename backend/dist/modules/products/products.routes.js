...
productsRoutes.get("/facets", optionalAuthenticateJwt, validate(productFacetsSchema), productsController.getFacets);
productsRoutes.get("/search", optionalAuthenticateJwt, validate(productSearchSchema), productsController.search);
