...
const opinionsController = {
    createOnProduct: async (req, res) => {
        ...
        const opinion = await opinionsService.createOnProduct(productId, userId, req.body);
    ...
    createThread: async (req, res) => {
        ...
        const thread = await opinionsService.createThread(opinionId, userId, req.body);
