...
export type ListChangeRequestsQuery = z.infer<
  typeof listChangeRequestsSchema
>["query"];
export type ListMyChangeRequestsQuery = z.infer<
  typeof listMyChangeRequestsSchema
>["query"];
